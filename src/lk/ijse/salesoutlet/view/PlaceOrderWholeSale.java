...
import lk.ijse.salesoutlet.controller.PlaceOrderWholeSaleController;
...
public class PlaceOrderWholeSale extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PlaceOrderCredit1
     */
    public PlaceOrderWholeSale() {
        initComponents();
        ...
        cmbCustomerID.requestFocusInWindow();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Place Order - WholeSale");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 290, 40));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Order ID");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 80, 70, 32));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 790, 9));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText(" Order Date");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 90, 30));
        ...
        cmbProductCode.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 84, -1, 20));
        ...
        jPanel2.add(txtDiscount, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 80, 70, 30));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 780, 120));
        ...
        tblProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Double.class
            };
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 790, 210));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 790, 240));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 310, 790, 10));
        ...
        jPanel1.add(btnRemove, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 630, 136, 37));
        ...
        jPanel1.add(btnAddOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 630, -1, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText(" Customer ID");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 100, 32));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setText("Customer Name");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, 120, 30));
        ...
        jPanel1.add(cmbCustomerID, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 100, 30));

        lblCustomerName.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblCustomerName.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(lblCustomerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 130, 210, 30));

        lblOrderID.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblOrderID.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(lblOrderID, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 80, 100, 30));

        lblOrderDate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblOrderDate.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(lblOrderDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 80, 130, 30));

        lblTotalAmount.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(lblTotalAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 560, 110, 30));

        jLabel17.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel17.setText("Total Amount and Total Discount");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 560, 190, 30));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel16.setText(" NET AMOUNT");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 590, 90, 30));
        ...
        jPanel1.add(lblNetAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 590, 110, 30));

        lblTotalDiscount.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(lblTotalDiscount, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 560, 90, 30));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("-");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 570, 20, 10));

        jLabel18.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel18.setText("No of Products");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 560, 90, 30));
        ...
        jPanel1.add(lblNumberOfProducts, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 560, 40, 30));
    ...
    private void btnAddOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddOrderActionPerformed
        ...
        try {
            boolean isOrderAdded = PlaceOrderWholeSaleController.placeOrder(payment, order, orderDetails);
            if (isOrderAdded) {
                JOptionPane.showMessageDialog(this, "Order Added Successfully");
                
                JasperUtil.init(PlaceOrderWholeSale.class);
            ...
            Logger.getLogger(PlaceOrderWholeSale.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void txtDiscountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDiscountActionPerformed
        ...
        double wholeSaleUPrice = Double.parseDouble(lblSellingUPrice.getText());
        double qty = Double.parseDouble(txtQty.getText());
        double discount = Double.parseDouble(txtDiscount.getText());
        amount = wholeSaleUPrice * qty;
        totalAmount += amount;
        ...
        dtm.addRow(new Object[]{code, description, unitQty, wholeSaleUPrice, qty, amount, discount});
    ...
    private void cmbCustomerIDItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbCustomerIDItemStateChanged
        ...
        CustomerDTO customerDTO = new CustomerDTO(customerId, null, null, null);
        try {
            CustomerDTO searchedCustomer = ManageCustomerController.searchCustomer(customerDTO);
            lblCustomerName.setText(searchedCustomer.getCustomerName());
        } catch (Exception ex) {
            Logger.getLogger(PlaceOrderWholeSale.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void cmbProductCodeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbProductCodeItemStateChanged
        String code = (String) cmbProductCode.getSelectedItem();
        ProductDTO productDTO = new ProductDTO(code, null, 0, 0, 0, null, 0);
        try {
            ProductDTO searchedProduct = ManageProductController.searchProduct(productDTO);
            lblDescription.setText(searchedProduct.getDescription());
            lblUnitQty.setText(searchedProduct.getUnitQty());
            lblSellingUPrice.setText(Double.toString(searchedProduct.getWholeSaleUPrice()));
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            totalDiscount -= (double) dtm.getValueAt(selectedRow, 6);
    ...
    private void loadCurrentOrderID() {
        try {
            currentOrderId = PlaceOrderWholeSaleController.getCurrentOrderID();
    ...
    private void getCurrentPaymentID() {
        ...
        try {
            paymentId = PlaceOrderWholeSaleController.getCurrentPaymentId();
